...
@NgModule({
  declarations: [HomeComponent, FiltersComponent, SearchComponent, EditComponent, AddComponent, ViewerComponent, DetailComponent, DashboardComponent, SidenavComponent],
  imports: [
    ...
    MatInputModule, MatCheckboxModule, MatFormFieldModule, FlexLayoutModule
  ],
