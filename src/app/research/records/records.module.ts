...
import { MatButtonModule, MatToolbarModule, MatIconModule, MatListModule, 
  ...
  MatPaginatorModule, MatSortModule, MatRadioModule, MatDatepickerModule, MatNativeDateModule, MatOptionModule, MatSelectModule } from '@angular/material';
...
@NgModule({
  declarations: [HomeComponent, FiltersComponent, SearchComponent, 
    ...
    DashboardComponent, SidenavComponent, RecordTypePipe, PersonRolePipe, ConnectPersonsComponent, PersonsComponent],
  imports: [
